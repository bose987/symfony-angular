...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    .constant('SatellizerConfig', {
      ...
      cordova: false,
      baseUrl: '/',
      loginUrl: 'https://angular-symfony-api.herokuapp.com/app_dev.php/api/login',
      signupUrl: 'https://angular-symfony-api.herokuapp.com/app_dev.php/api/signup',
      ...
      providers: {
        facebook: {
          name: 'facebook',
          url: 'https://angular-symfony-api.herokuapp.com/app_dev.php/api/facebook/login',
          authorizationEndpoint: 'https://www.facebook.com/v2.3/dialog/oauth',
          redirectUri: window.location.origin + '/',
          //redirectUri: 'http://pltw.lcl/app_dev.php/facebook/add',
